...
$(document).ready(function(){
	...
	************************/
	//automatic slider
	// var autoSlider = setInterval(slideRight1, 3000);
	
	//for each slide 
	$.each($('#slider-wrap1 ul li'), function(index,item) { 
     //set its color
  
	   var c = $(item).attr("data-color");
	...
	$('#slider-wrap1').hover(
		...
		//autoSlider = setInterval(slideRight1, 3000); 
	);
