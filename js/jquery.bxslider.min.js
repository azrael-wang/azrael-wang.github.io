...
function(t) {
    ...
    t.fn.bxSlider = function(n) {
        ...
        c = function() {
            r.wrap('<div class="bx-wrapper" style=" margin-top:100px;height:695px;display:block;"><div class="bx-viewport"></div></div>'),
            o.viewport = r.parent(),
        ...
        w = function() {
            ...
            i = x(), s = 0; i > s; s++) {
                ...
                e += '<div class="bx-pager-item"><a href="" data-slide-index="' + s + '" class="bx-pager-link">'+"</a></div>"
            }
            o.pagerEl.html(e)
        },
        T = function() {
        ...
        B = function() {
            ...
            i = t(window).height(); (a != e || l != i) && (a = e, l = i, r.redrawSlider())
        };
