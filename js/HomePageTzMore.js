$(function () {
	...
	var options = {
		...
		"callBack": function (result) {
			...
			for (var i = 0; i < result.length; i++) {
				...
				cHtml += '<li><a href="../subPage/subTZinfo.html?id=' + result[i].id + '"><p class="date"> ' + Year + '</p><p class="title">' + result[i].title + '</p></a></li>'
				//处理数据
			}
	...
	var newsMoreLanguage = {
		...
		titleBreadCn: ['当前位置：<a href="../index.html">个人主页</a>&bull;通知公告'],
		titleBreadEn: ['Current location:<a href="../subPage/Homepage.html">Home</a>&bull;Announcement'],
