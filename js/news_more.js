$(function () {
	...
	let options = {
		...
		"callBack": function (result) {
			...
			for (var i = 0; i < result.length; i++) {
				...
				cHtml += '<li><a href="../subPage/news_info.html?id=' + result[i].id + '"><p class="date"> ' + Year + '</p><p class="title">' + result[i].title + '</p></a></li>'
				//处理数据
			}
	...
	var newsMoreLanguage = {
		titleCn: ["新闻资讯", ],
		titleEn: ["News", ],
		titleBreadCn: ['当前位置：<a href="../index.html">首页</a>&bull;新闻资讯'],
