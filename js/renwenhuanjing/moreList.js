...
let options = {
	...
	"callBack": function(result) {
		...
		for (var i = 0; i < result.length; i++) {
			...
			// cHtml +='<li><a href="../subPage/jyjy_info.html?id='+ result[i].id +'"><p class="date"> '+ result[i].date +'</p><p class="title">'+ result[i].title +'</p></a></li>'
			cHtml += '<li><a href="./infro_sverver.html?index=0&rwhjIndex:' + i + '"><img src="' + (result[i].remark) +
				'" alt=""></a>'
			//处理数据
		}
